...
<div class="clear"> </div>
	...
	<div class="mid-grids">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						<div class="jumbotron">
							<div class="container">
								<strong>Bienvenido al CRUD de bebidas.</strong><br>
								<em>Esta es la seccion para administrar las bebidas de resturante.</em>
							</div>
						</div>
					</div>
					<div class="col-md-7">
						...
						<div class="panel panel-primary">
							<div class="panel-body">
								<form class="form-horizontal" onsubmit="return validarFormulario(this)" action="<%= blobstoreService.createUploadUrl("/guardarbebida") %>" method="post" enctype="multipart/form-data" >
									
										<input type="hidden" id="idBebida" name="idBebida" value="vacio" />																
										<div class="form-group">
		...
		<div class="row">
			<div class="col-md-7">
				<form class="form-horizontal" >
					<div class="form-group">
						<label for="ejemplo_password_3" class="col-lg-4 control-label" for="Categoria">Mostrar bebidas por: </label>
						<div class="col-lg-6">
								<select class="form-control" id="buscarbebida">
		...
		<div  class="panel panel-default">
		  <div class="panel-heading">Registro de bebidas</div>	      
		    <!-- div para el ajax-->
		    <div id="registro_bebidas">
